...
export async function loadZarr(config, mapProjection) {
  ...
  registerUTMProjections(); // resolve UTM store CRSs
...
// Register proj4 + all WGS84 UTM zones so ol can reproject projected sources.
let projectionsRegistered = false;
export function registerUTMProjections() {
